...
public class FrankScenarySelectMobilityBolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
        ...
        try {
            ...
            if(cursor== null){
                ...
                while (cursor.hasNext()) {
                    ...
                    if (doc == null) break;
                        ...
                        BasicDBObject userselect = new  BasicDBObject("id_raw", id)
                                ...
                                .append("scenarytype", Config.Database.MOBILITY_XDR_COLLECTION )
                ...
                _collector.emit(TopologiesIDs.FrankStreamNames.FRANK_SCENARY_SELECT_MOBILITY_TO_RECURSIVE_ALGORITM, tuple, new Values( JSON.serialize(allxdrs), Config.Database.MOBILITY_XDR_COLLECTION ) );
                _collector.ack(tuple);
            }
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        ...
        outputFieldsDeclarer.declareStream(TopologiesIDs.FrankStreamNames.FRANK_SCENARY_SELECT_MOBILITY_TO_RECURSIVE_ALGORITM, new Fields("grupos_by_user","scenary_type"));
