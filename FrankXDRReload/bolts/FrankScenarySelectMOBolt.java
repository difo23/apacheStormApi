 ...
 */
public class FrankScenarySelectMOBolt extends BaseRichBolt {

    private static final Logger LOG = LoggerFactory.getLogger(FrankScenarySelectMOBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        try {
            ...
            MongoCursor cursor = _mongodb.find(Config.Database.MO_CALL_XDR_DATABASE, Config.Database.MO_CALL_XDR_COLLECTION, where);
   ...
   /*                     ObjectId id = (ObjectId) doc.get("_id");
                        BasicDBObject userselect = new  BasicDBObject("id_raw", id)
                                ...
                                .append("scenarytype", Config.Database.MO_CALL_XDR_COLLECTION )
...
*/
                ...
                _collector.emit(TopologiesIDs.FrankStreamNames.FRANK_SCENARY_SELECT_MO_TO_RECURSIVE_ALGORITM, tuple, new Values( JSON.serialize(allxdrs), Config.Database.MO_CALL_XDR_COLLECTION) );
                _collector.ack(tuple);
            }
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        ...
        outputFieldsDeclarer.declareStream(TopologiesIDs.FrankStreamNames.FRANK_SCENARY_SELECT_MO_TO_RECURSIVE_ALGORITM, new Fields("grupos_by_user","scenary_type"));
