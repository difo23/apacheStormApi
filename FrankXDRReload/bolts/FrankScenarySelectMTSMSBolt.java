 ...
 */
public class FrankScenarySelectMTSMSBolt extends BaseRichBolt {

    private static final Logger LOG = LoggerFactory.getLogger(FrankScenarySelectMTSMSBolt.class);
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector outputCollector) {
        ...
        _mongodb = MongoDBConnector.getConnector(new ServerConnection(Config.Database.MT_SMS_SERVER_IP,
                Config.Database.MT_SMS_SERVER_PORT));
    }
    ...
    public void execute(Tuple tuple) {
        ...
        try {
            ...
            MongoCursor cursor = _mongodb.find(Config.Database.MT_SMS_XDR_DATABASE, Config.Database.MT_SMS_XDR_DATABASE, where);
          ...
          //  MongoCursor<Document> cursor =coll_mo.find(or(eq("msisdn", user.get("msisdn")), eq("imei",
            ...
            if(cursor== null){
               ...
               // this._collector.emit( new Values(" No existen datos corralados por escenarios! ", _retInfo));
                    ...
                    if (doc == null) break;
                      ...
                      /*  ObjectId id = (ObjectId) doc.get("_id");
                        BasicDBObject userselect = new  BasicDBObject("id_raw", id)
                                ...
                                .append("scenarytype", Config.Database.MT_SMS_XDR_COLLECTION)
                ...
                _collector.emit(TopologiesIDs.FrankStreamNames.FRANK_SCENARY_SELECT_MT_SMS_TO_RECURSIVE_ALGORITM, tuple, new Values( JSON.serialize(allxdrs), Config.Database.MT_SMS_XDR_DATABASE) );
                _collector.ack(tuple);
            }
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        ...
        outputFieldsDeclarer.declareStream(TopologiesIDs.FrankStreamNames.FRANK_SCENARY_SELECT_MT_SMS_TO_RECURSIVE_ALGORITM, new Fields("grupos_by_user","scenary_type"));
