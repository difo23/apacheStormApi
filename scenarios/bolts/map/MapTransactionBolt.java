package com.ayscom.minetur.scenarios.bolts.map;
 ...
 */
public class MapTransactionBolt extends ScenariosBolt {

    OutputCollector _collector;

    static Logger LOG = Logger.getLogger(MapTransactionBolt.class);
